...
//         fs.writeFileSync(file, JSON.stringify([])); // Create file if missing
//         return [];
//     }
...
//         const access_token = jwt.sign({ email }, SECRET_KEY, { expiresIn: '1h' });
...
//     const newNote = { id: Date.now(), email: req.user.email, title, content };
//     notes.push(newNote);
